    ...
    <div class="container mt-4">
      ...
      <div class="d-flex align-items-center logo-labs position-relative mb-5">
        ...
        <div class="border border-0 border-start ms-2 ps-4">
          <h2 class="text fs-2 fw-semibold border-bottom border-primary text-white "> <span class=" position-absolute "
            ...
            top: 4rem;
        ">SSRF </span>
            <a href="../SSRF description.html"><br><span class="text2 fs-5 text-white">Back to lab description <small
      ...
      <div class="container">
        ...
        <div class="home home text-white d-flex fs-3    justify-content-end">
          <p class=" home text-white d-flex "><a class="text-white" href="../ssrf.php">Home</a>  </p>
          </p>
          </p>
        </div>
      ...
      <div class="container">
        <div class="rate mb-3 text-white">
          <p class="mb-4"> Grow Your Own Spy Kit</p><img class="me-5 mb-3" src="../../imgs/rating4.png">
          <p class=" price mb-3 d-flex flex-end"> " $63.66"</p>
        </div>
        <div class="g-col-4 text-white mb-5  "> <img class="rounded w-75 h-75 mb-3" src="../../imgs/image (1).jpeg "
            alt="">
          <h2 class=" text-white"> Description:</h2>
          <p class="mb-5">
            Everyone is getting wise to the nanny cams, and the old fashioned ways of listening in on other people's
            conversations. No-one trusts a cute looking teddy bear anymore, who knows what is hidden behind those button
            eyes. We have designed a foolproof system that will never catch you out with our 'Grow Your Own Spy Kit'.
            In the same easy way you plant a seed, or seedling, you pop the water-resistant bug beneath the surface of
            some fresh compost. With regular watering and a sprinkling of plant food, your bug pots will thrive until
            they are ready to be gifted to those you wish to spy on.
            No-one will suspect what you're up to, even if they have their suspicions, the only bugs they are going to
            find hiding amongst the leaves will be greenfly.
            On purchasing our 'Grow Your Own Spy Kit' you will be required to sign a Non-Disclosure Agreement, loose
            lips cost lives you know.
            Whether you are planning on just having a bit of fun with your family and friends, or you are a serious spy
            in the making, eavesdropping could not be any easier</p>
        </div>
        <div class="return  "> </a>
