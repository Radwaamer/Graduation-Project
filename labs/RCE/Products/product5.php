...
<body>
  ...
  <div class="xss d-flex flex-column justify-content-center align-items-center mb-5">
    <div class="container mt-4">
     ...
     <p class=" home text-white d-flex mt-5 "><a class="text-white" href="../RCE.html">Home</a>  </p></div>
          
    </div>
<div class="container">
          <div class="rate mb-3 text-white"> <p class="mb-4"> Your Virtual Journey Starts Here
          </p><img class="me-5 mb-3" src="../../imgs/rating1.png"><p class=" price mb-3 d-flex flex-end"> " $63.66"</p>
          </div>
       <div class="g-col-4 text-white mb-5  "> <img class="rounded w-75 h-75 mb-3" src="../../imgs/image.jpeg" alt="">
     <h2 class=" text-white"> Description:</h2>
        <p class="mb-5">
          ...
          Whether you are planning on just having a bit of fun with your family and friends, or you are a serious spy in the making, eavesdropping could not be any easier</p>
         </div>  
   <div class="return  ">  </a>
