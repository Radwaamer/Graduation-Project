    ...
    <div class="card w-50 mx-auto position-fixed top-50 start-50 translate-middle border-0">
        <div class="card-body position-relative">
            ...
            <form action="">
                ...
                <button class="forget-btn btn text-white w-100 py-2 fs-5 mt-3 mb-4 fw-semibold" type="submit">Send Pass</button>
            </form>
...
function forgetPass(){
    ...
    document.querySelector(".forgetPass .layout").addEventListener("click",()=>{
        document.querySelector(".forgetPass").classList.add("d-none");
    });
    document.querySelector(".forgetPass .card .exit").addEventListener("click",()=>{
        document.querySelector(".forgetPass").classList.add("d-none");
    });
